...
router.delete('/', async (req, res) => {
  try {
    const userId = req.user.id;
    const profilePictures = await db.select().from(schema.profilePictures).where(eq(schema.profilePictures.userId, userId));
    ...
    await db.delete(schema.profilePictures).where(eq(schema.profilePictures.userId, userId));
