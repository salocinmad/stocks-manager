        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              step="0.00000001"
              min="0"
              placeholder="Precio para activar Stop Loss"
              value={formData.stopLossPrice || ''}
              onChange={handleInputChange}
            />
            <p style={{ fontSize: '12px', color: 'rgb(136, 136, 136)', marginTop: '5px' }}>Ingresa el precio al que se activará la alerta de Stop Loss</p>
          </div>
