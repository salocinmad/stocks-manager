  ...
  return (
    <div className="container">
      ...
      <div className="header">
        <h1>📊 Portfolio {currentUser?.username || 'Usuario'}</h1>
        <div>
                  ...
                  {Object.entries(activePositions).map(([positionKey, position]) => {
                    ...
                    return (
                      <tr key={positionKey}>
                        ...
                        <td>€{avgCostPerShare.toFixed(2)}</td>
                        <td>
                          {currentPriceData ? (
                            <div>
                            ...
                            <span style={{ color: '#888', fontSize: '12px' }}>
                              {finnhubApiKey ? 'Sin datos' : 'Sin API Key'}
                            </span>
                          )}
                        </td>
                        <td>
          ...
          {Object.keys(activePositions).length > 0 && chartData.length > 0 && (
            <div className="card">
                  ...
                  <PieChart>
                    <Pie
                      ...
                      label={({ name, value, percent }) => {
                        // Mostrar siempre el nombre con el valor
                    ...
                    <Tooltip
                      formatter={(value, name) => {
                        ...
                        return [`€${Number(value).toFixed(2)} (${percentage}%)`, name.split(':')[0]];
                      }}
                      contentStyle={{
              ...
              {chartData.length === 1 && chartData[0].name === 'Sin datos' && (
                <p style={{ textAlign: 'center', color: '#888', marginTop: '10px', fontSize: '12px' }}>
                  Actualiza los precios para ver las ganancias
                </p>
              )}
            </div>
          )}
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: 'flex', gap: '15px', fontSize: '14px' }}>
                              ...
                              <div>
                                <strong>Coste promedio:</strong> €{avgCostPerShare.toFixed(2)}
                              </div>
                              <div>
